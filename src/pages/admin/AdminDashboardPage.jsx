...
import { FiBarChart2, FiUserCheck, FiFileText } from "react-icons/fi";
...
const AdminDashboard = () => {
  return (
    <div className="bg-gradient-to-r from-[#0d0d0d] to-[#0f1a1f] min-h-screen p-6 text-white">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="bg-red px-4 py-2 rounded-md text-sm">
          View All Cases →
        </button>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        ...
        {/* CASE STATUS */}
        <div className="col-span-2 bg-[#16232d] border border-[#1f2f3a] rounded-xl p-5">
