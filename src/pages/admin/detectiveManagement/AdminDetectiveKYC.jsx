    ...
    <div className="p-6 montserrat text-white bg-[#08141B] min-h-screen">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div>
          ...
          <h1 className="text-lg font-semibold">Detective Sophia Anderson</h1>
          <p className="text-xs lightGray">Insurance Fraud</p>
        </div>

        <div className="flex gap-2">
          <button className="px-4 py-1 text-xs rounded-lg bg-green-500/20 text-green-400">
            Approve KYC
          </button>
          <button className="px-4 py-1 text-xs rounded-lg bg-red-500/20 text-red-400">
            Reject KYC
          </button>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <Card title="Personal Information">
          ...
          <p><span className="lightGray">Email:</span> s.anderson@detectiveagency.com</p>
